...
As for the file structure, a pdf file is enough for reading, for you can get the problem description from the hyperlink at the top of pdf file(**You need download it to click the hyperlink rather than open in in Github**) or through opening **[All Problems Description Hyperlink](https://github.com/SuperKuroko/Leet-Code/blob/main/All%20Problems%20Description%20Hyperlink.md)** in this repository.    
But if you need source files, you can go to **[/Source File](https://github.com/SuperKuroko/Leet-Code/tree/main/Source%20File)** to get them. If a problem has serveral solutions, all of them will be stored in a single file.
...
该库的文件架构分开PDF文件部分与源文件夹。单个PDF文件是足够满足对于该题的阅读需求的，您可以通过PDF中给出的题目描述的超链接(需要下载PDF才能点击,GitHub中打开是无法点击的)来获取题目信息，也可以通过该库中的 **[All Problems Description Hyperlink](https://github.com/SuperKuroko/Leet-Code/blob/main/All%20Problems%20Description%20Hyperlink.md)** 来获取。
PDF文件中描述了对于该题的一种或多种思路与算法，最后在文件末尾给出了力扣上通过的源代码，以C++与Python3为主。 
如果您需要PDF中描述的源代码，可以打开 **[Source File](https://github.com/SuperKuroko/Leet-Code/tree/main/Source%20File)** 文件夹以获取，需要注意的是，如果某个问题有多种解法，他们都将被存储在同一个源文件下，以为了让目录显得简约。
